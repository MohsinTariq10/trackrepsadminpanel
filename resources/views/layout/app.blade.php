            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li class="active">
                            <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> Admin Panel</a>
                        </li>
                        <li>
                            <a href="members.html"><i class="fa fa-fw fa-bar-chart-o"></i> Add Members</a>
                        </li>
                        <li>
                            <a href="all-members.html"><i class="fa fa-fw fa-edit"></i> View Members Detail</a>
                        </li>
                        <li>
